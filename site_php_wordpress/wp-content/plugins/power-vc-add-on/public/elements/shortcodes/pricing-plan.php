<?php
function vision_webnus_pricing_plan( $atts, $content = null ) {
	...
	$link_text = $link_text ? '<a href="'. esc_url($link_url) .'" class="pa-readmore">'. esc_html($link_text) .'</a>' : '' ;
...
add_shortcode( 'pa_pricing-plan','vision_webnus_pricing_plan' );