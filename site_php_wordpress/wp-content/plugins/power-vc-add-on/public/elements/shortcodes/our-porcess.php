<?php
function  vision_webnus_our_process_shortcode( $attributes, $content ) {
	...
	// render
	$out  = '<div id="pa-wrap" class="pa-wrap"><div class="pa-our-process-wrap">';
		foreach ( $process_item_data as $line ) :
			// Enqueue needed icon font
			vc_icon_element_fonts_enqueue( 'fontawesome' );
			$out .= '
				<div class="pa-our-process-item ">
...
add_shortcode( 'pa_our_process', 'vision_webnus_our_process_shortcode' );