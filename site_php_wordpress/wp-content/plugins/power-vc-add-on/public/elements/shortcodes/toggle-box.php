<?php
function pa_toggle_box ( $atts, $content = null ) {
...
echo '<div id="pa-wrap" class="pa-wrap">';
		...
		if ( $type == 1 ) {
			...
			$out = '
			<div class="pa-suite-toggle" ' . $background . ' >
				<div class="main-content">
					'. $service_single_title . '
					<div class="pa-service-icon">
						<i class="'.$icon_name.'"></i>
					</div>
				</div>
				<div class="pa-toggle-content">
			...
			$out = '
			<div class="pa-offer-toggle" ' . $background . ' >
				<figure>
					<div class="main-content">
						' . $icon . '
						' . $offers_subtitle . '
						' . $offers_title . '
						' . $plus_icon . '
						<div class="pa-toggle-content  '. $hide_content . '">
							' . $offers_main_content . '
						</div>
					</div>
				</figure>
...
echo '</div>';
	...
	add_shortcode( 'pa_toggle_box','pa_toggle_box' );