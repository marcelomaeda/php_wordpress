<?php
function pa_gmap ($atts, $content = null) {
	...
	$map_api				= ($map_api) ? $map_api : 'no-api-key';
	...
	<?php } ?>
	<script async defer
    src="https://maps.googleapis.com/maps/api/js?key=<?php echo $map_api; ?>">
    </script>
