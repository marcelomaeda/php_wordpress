<?php
function pa_testimonial_carousel( $atts, $content = null ) {
	...
	foreach ( $testimonial_item as $data ) :
		...
		if ( $data['thumbnail'] ) {
			...
			$arr = explode('*', $data['thumbnail']); // get width and height
	...
	if ( $type == '1' ) { 
		...
		$out = '<div id="pa-wrap" class="pa-wrap">';
			$out .= '<div class="pa-testimonial-carousel pa-testi-carou-' . $type . '">';
				$out .= '<div class="pa-testimonial-owl-carousel owl-carousel owl-theme" data-testimonial_count="' . $items . '">';
...
add_shortcode( 'pa_testimonial-carousel', 'pa_testimonial_carousel' );