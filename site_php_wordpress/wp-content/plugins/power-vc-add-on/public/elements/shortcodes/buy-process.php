<?php
function  pa_buy_process_shortcode( $attributes, $content ) {
	...
	<div id="pa-wrap" class="pa-wrap">
		<div class="pa-buy-process-wrap"' . $bg_color . '>
			<div class="pa-buy-process-items">';
				foreach ( $process_item_data as $line ) :
					$out .= '
					<div class="pa-buy-process-item' . $line['process_style'] . '">
						<div class="text-wrap">
...
add_shortcode( 'pa_buy_process', 'pa_buy_process_shortcode' );