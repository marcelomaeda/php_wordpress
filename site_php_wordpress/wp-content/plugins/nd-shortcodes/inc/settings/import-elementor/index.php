              ...
              if ( is_plugin_active($nicdark_elementorpro_path) or is_plugin_active($nicdark_proelements_path) ) { 
                ...
                <div class="nd_options_box_sizing_border_box nd_options_padding_20 nd_options_float_left nd_options_width_100_percentage">
                  <div class="notice notice-error nd_options_padding_20 nd_options_margin_top_30 nd_options_margin_0 nd_options_background_color_d6363917">
                    <p><strong>'.esc_html__('FREE PRO Elements or Elementor PRO plugins required','nd-shortcodes').' : </strong><br/>'.esc_html__('One of these two plugins are not installed. You bought this theme with "Elementor PRO" indication needed to use some demos. You have 3 solutions, chose the best for you and download one of these ( Once you have installed and activated one of these two plugins, return and reload this page to import your demo ) : ','nd-shortcodes').'</p>


                    <ul class="nd_options_padding_left_13 nd_options_list_style_disc">
                    	<li><p>'.esc_html__('Download PRO Elements now ( FREE )','nd-shortcodes').' <a target="_blank" href="https://proelements.org/">'.esc_html__('Download','nd-shortcodes').'</a></p></li>
                    	<li><p>'.esc_html__('Purchase Elementor PRO official by Nicdark ( $ 9 / year )','nd-shortcodes').' <a target="_blank" href="https://www.nicdark.com/themes/elementor-pro/">'.esc_html__('Download','nd-shortcodes').'</a></p></li>
                    	<li><p>'.esc_html__('Purchase Elementor PRO official by Elementor ( $ 59 / year )','nd-shortcodes').' <a target="_blank" href="https://elementor.com/pricing-plugin/">'.esc_html__('Download','nd-shortcodes').'</a></p></li>
                    </ul>


                    <a target="blank" href="https://www.nicdark.com/demos-with-elementor-pro/">'.esc_html__('IMPORTANT : Compare the various possibilities here','nd-shortcodes').'<p></p></a>
                  </div>
                </div>
                <!--plugins notice-->';
